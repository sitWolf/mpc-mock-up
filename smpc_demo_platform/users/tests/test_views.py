...
from smpc_demo_platform.users.models import User
from smpc_demo_platform.users.tests.factories import UserFactory
from smpc_demo_platform.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
